...
CREATE TABLE IF NOT EXISTS store_tv_device (
    ...
    store_id BIGINT UNSIGNED DEFAULT NULL COMMENT '所属门店ID，空闲设备为NULL',
...
CREATE TABLE IF NOT EXISTS child_profile (
    ...
    relation VARCHAR(20) COMMENT '与儿童关系：妈妈/爸爸等',
    birth_date DATE COMMENT '出生日期',
    gender TINYINT COMMENT '性别:0女 1男',
    home_address VARCHAR(255) COMMENT '家庭地址',
    school VARCHAR(100) COMMENT '所在学校',
    delivery_type VARCHAR(20) COMMENT '分娩方式：顺产/剖宫产',
    bedtime VARCHAR(10) COMMENT '日常作息-休息时间(HH:mm)',
    wake_time VARCHAR(10) COMMENT '日常作息-起床时间(HH:mm)',
    id_card_encrypted VARCHAR(512) COMMENT '身份证号(加密)',
    eye_condition TEXT COMMENT '眼部状况',
    naked_vision_both VARCHAR(20) COMMENT '裸眼视力-双眼',
    naked_vision_left VARCHAR(20) COMMENT '裸眼视力-左眼',
    naked_vision_right VARCHAR(20) COMMENT '裸眼视力-右眼',
