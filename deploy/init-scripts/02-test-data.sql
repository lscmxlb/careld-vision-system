...
-- 门店科室
-- ============================================================
INSERT INTO store_department (store_id, dept_code, dept_name, dept_type, sort_order, status) VALUES
(1, 'DEPT001', '视光门诊', 1, 1, 1),
(1, 'DEPT002', '视力养护', 2, 2, 1),
(1, 'DEPT003', '视力检测', 3, 3, 1),
(2, 'DEPT001', '视光门诊', 1, 1, 1),
(2, 'DEPT002', '视力养护', 2, 2, 1),
(3, 'DEPT001', '视光门诊', 1, 1, 1),
(3, 'DEPT003', '视力检测', 3, 2, 1);
...
SELECT CONCAT('✅ 测试数据插入完成！',
  ...
  '\n  科室: ', (SELECT COUNT(*) FROM store_department), ' 条',
